...
{
    set_ennemies_rotation(env, ennemies_id, ROTATION_RIGHT);
    set_ennemies_animation(env, ennemies_id);
    env->ennemies_s[ennemies_id].pos.x += 10 * env->core_s.delta_time;
    sfSprite_setPosition(env->ennemies_s[ennemies_id].s_ennemies, env->ennemies_s[ennemies_id].pos);
}

void ennemies_movement_left(env_t *env, int ennemies_id)
{
    set_ennemies_rotation(env, ennemies_id, ROTATION_LEFT);
    set_ennemies_animation(env, ennemies_id);
    env->ennemies_s[ennemies_id].pos.x -= 10 * env->core_s.delta_time;
    sfSprite_setPosition(env->ennemies_s[ennemies_id].s_ennemies, env->ennemies_s[ennemies_id].pos);
}
...
{
    set_ennemies_rotation(env, ennemies_id, ROTATION_UP);
    set_ennemies_animation(env, ennemies_id);
...
{
    set_ennemies_rotation(env, ennemies_id, ROTATION_DOWN);
    set_ennemies_animation(env, ennemies_id);
    env->ennemies_s[ennemies_id].pos.y += 10 * env->core_s.delta_time;
    sfSprite_setPosition(env->ennemies_s[ennemies_id].s_ennemies, env->ennemies_s[ennemies_id].pos);
}